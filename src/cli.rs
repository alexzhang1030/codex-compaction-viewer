...
fn should_launch_tui_with(
    args: &Args,
    arg_count: usize,
    stdin_is_terminal: bool,
    stdout_is_terminal: bool,
) -> bool {
    !args.version && (args.tui || arg_count == 1) && stdin_is_terminal && stdout_is_terminal
}

fn mouse_capture_enabled(args: &Args) -> bool {
    !args.no_mouse
}
